...
The canonical production model is a portable Next.js standalone container managed with Docker Compose. Phase 0 and Phase 1 establish only the repository, design system, theme, health route, tests, and deployment foundation. Public site navigation and content remain approval-gated.
...
BR-017 Phase 0/1 work is performed on `feature/br-017-foundation` and remains unmerged until approved.

## Current limitations

- The visible root route is a temporary foundation smoke surface, not the Website v1 homepage.
- Public navigation and content routes begin in Phase 2 after approval.
