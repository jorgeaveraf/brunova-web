...
| `N8N_CONTACT_WEBHOOK_SECRET` | Contact activation | Runtime                | Yes                                   | Non-empty bearer secret                            | generated secret value                       | Same grouped behavior as above                                                                                            |
| `CONTACT_RATE_LIMIT_SALT`    | Contact activation | Runtime                | Yes                                   | Random value of at least 16 characters             | generated random value                       | Same grouped behavior as above                                                                                            |
...
| `N8N_CONTACT_WEBHOOK_SECRET`            | Server-to-server authentication        | Yes                        | generated bearer secret                         | n8n workflow owner             | Yes to activate contact         |
