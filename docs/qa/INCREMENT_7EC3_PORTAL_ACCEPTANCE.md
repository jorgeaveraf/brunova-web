...
- Overview now distinguishes the fourth window's decision slot from zero executed WorkItems, zero source requests and zero new company evidence. A1 acceptance and A2 not-applicable are scoped to that historical window.
